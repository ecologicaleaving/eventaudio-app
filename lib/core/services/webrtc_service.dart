...
class WebRtcService {
  ...
  Future<void> joinChannel(
    ...
    // Send our RTP capabilities so server can create consumers for us.
    ...
    final joinResp = await _socketEmit('join-channel', payload);

    if (joinResp['ok'] == false) {
      throw Exception(joinResp['error'] ?? 'join-channel failed');
    }
